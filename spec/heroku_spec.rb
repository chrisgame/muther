...
describe 'the heroku api wrapper' do
  ...
  it 'should return a release count for all site' do
    ...
    last_response.body.should eq '{"advanced_diagnostics":{"release_count":0},"announcements":{"release_count":0},"broadband_connection":{"release_count":0},"diagnostics":{"release_count":2},"help":{"release_count":0},"help_editor":{"release_count":3}}'
  end
