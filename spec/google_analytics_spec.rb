...
describe 'the google analytics api wrapper' do
  ...
  it 'should return information for all sites' do
    ...
    last_response.body.should eq '{"advanced_diagnostics":{"unique_visitors":"8188","average_page_load_time":"3.938288732394366"},"broadband_connection":{"unique_visitors":"28288","average_page_load_time":"4.661843205574913"},"diagnostics":{"unique_visitors":"8188","average_page_load_time":"3.938288732394366"},"help":{"unique_visitors":"129763","average_page_load_time":"5.572747933884298"}}'
  end
